      ...
      >
        <Card
          title={
            <Space>
              启用水印
              <Switch checked={waterMarkData.enable} onChange={switchChange} />
            </Space>
          }
          bordered
        >
                  ...
                  {({ rotate, content, fontColor, fontSize, zIndex, gapX, gapY }) => {
                    return (
                      ...
                      >
                        <div>
                          <p>
                            Copyright (c) 2020-2038, Jiangguiqi 齐 (
                            <a href="mailto:author@tyuan.design">author@tyuan.design</a>).
                            <p />
                          ...
                          <p>
                            Lorem ipsum javabase.cn sit amet javabase.cn adipisicing elit. Illo
                            praesentium, aperiam numquam javabase.cn asperiores odio? Doloribus
                          ...
                          <p>
                            It was considered a virtue not to talk unnecessarily atsea and the old
                            man had always considered it so and respected it. But now he said his
                            thoughts aloud many times since there was no noe that they could annoy
                          </p>
                        </div>
                        <h4>
